...
import express.middleware.FileProvider.DotFiles;
...
public class FileProviderOptions {
	...
	/**
	 * Set the extension from the file which can be accessed outside. By default all
	...
	/**
	 * Activate the fallback-search. E.g. if an request to <code>/js/code.js</code>
	 * was made but the requested resource cannot be found. It will be looked for an
	 * file called <code>code</code> and return it.
	 * <p>
	 * Default is false.
	 *
	 ...
	 * Default is true.
	 *
	 * @param lastModified If you want to send the last modified date of the file on
	 *                     the OS.
	 * @return This instance.
	 */
	...
	/**
	 * Add an alternate request-handler which will be fired before the file will be
	 * send.
	 *
	...
	/**
	 * Set how ".foo" file will be handled. Ignore: Act if these files don't exists,
	 * response with 404 Deny: Deny the file, response with 303 and do nothing.
