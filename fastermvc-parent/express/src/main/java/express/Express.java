...
public class Express implements Router {
	...
	public Express use(String root, ExpressRouter router) {
		...
		router.getHandler().forEach(fl -> fl.filter.forEach(layer -> {
	...
	public Express use(AbstractMiddleware middleware) {
		addMiddleware("*", "*", middleware);
		return this;
	}

	public Express use(String context, AbstractMiddleware middleware) {
		addMiddleware("*", context, middleware);
		return this;
	}

	public Express use(String context, String requestMethod, AbstractMiddleware middleware) {
		addMiddleware(requestMethod.toUpperCase(), context, middleware);
		return this;
	}

	// Internal service to handle middleware
	private void addMiddleware(String requestMethod, String context, AbstractMiddleware middleware) {
