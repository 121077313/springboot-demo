...
public interface Router {
   ...
   */
  Router use(AbstractMiddleware middleware);
   ...
   * @return The router itself to allow method call chaining.
   */
  Router use(String context, AbstractMiddleware middleware);
   ...
   * @return The router itself to allow method call chaining.
   */
  Router use(String context, String requestMethod, AbstractMiddleware middleware);
