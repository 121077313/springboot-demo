...
public class ExpressRouter implements Router {
	...
	public ExpressRouter use(AbstractMiddleware middleware) {
		addMiddleware("*", "*", middleware);
		return this;
	}

	public ExpressRouter use(String context, AbstractMiddleware middleware) {
		addMiddleware("*", context, middleware);
		return this;
	}

	public ExpressRouter use(String context, String requestMethod, AbstractMiddleware middleware) {
